...
const styles = StyleSheet.create({
  ...
  chartCard: { marginLeft: 12, backgroundColor: colors.white, borderRadius: 14, padding: 10, minWidth: 140, borderWidth: 1, borderColor: colors.border, justifyContent: "center" },
